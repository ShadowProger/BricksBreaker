...
namespace Manybits
{
    public class HorizontalLazer : Block
    {
        ...
        public override XmlNode Serialize(XmlDocument xml)
        {
            ...
            block.SetAttribute("type", "HorizontalLazer");
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            if (collision.gameObject.CompareTag("Ball"))
            {
                ...
                field.HitHorizontal(fieldPosition.y);
                needDelete = true;
            }
        }
        ...
        private void UpdateLinePosition()
        {
            ...
            horizontalLine.SetPosition(0, new Vector3(borders.xMin, transform.position.y, 1f));
            horizontalLine.SetPosition(1, new Vector3(borders.xMax, transform.position.y, 1f));
        }
    }
}
